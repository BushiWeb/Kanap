...
describe('FormValidator Unit Test Suite', () => {
    ...
    describe('validateBoundaries() Method Test Suite', () => {
        ...
        it('should return true if there is no boundary', () => {
            const validationResult = FormValidator.validateBoundaries(numberInput);
            expect(typeof validationResult).toBe('boolean');
            expect(validationResult).toBe(true);
        });

        it('should return true if the value is above the minimum', () => {
            const validationResult = FormValidator.validateBoundaries(numberInput, inputValue - 1);
            expect(typeof validationResult).toBe('boolean');
            expect(validationResult).toBe(true);
        });

        it('should return true if the value is the minimum', () => {
            const validationResult = FormValidator.validateBoundaries(numberInput, inputValue);
            expect(typeof validationResult).toBe('boolean');
            expect(validationResult).toBe(true);
        });

        it('should return a string if the value is bellow the minimum', () => {
            const validationResult = FormValidator.validateBoundaries(numberInput, inputValue + 1);
            expect(typeof validationResult).toBe('string');
        });

        it('should return true if the value is bellow the maximum', () => {
            const validationResult = FormValidator.validateBoundaries(numberInput, null, inputValue + 1);
            expect(typeof validationResult).toBe('boolean');
            expect(validationResult).toBe(true);
        });

        it('should return true if the value is the maximum', () => {
            const validationResult = FormValidator.validateBoundaries(numberInput, null, inputValue);
            expect(typeof validationResult).toBe('boolean');
            expect(validationResult).toBe(true);
        });

        it('should return a string if the value is above the maximum', () => {
            const validationResult = FormValidator.validateBoundaries(numberInput, null, inputValue - 1);
            expect(typeof validationResult).toBe('string');
        });

        it('should return true if the value is between the minimum and the maximum', () => {
            const validationResult = FormValidator.validateBoundaries(numberInput, inputValue - 1, inputValue + 1);
            expect(typeof validationResult).toBe('boolean');
            expect(validationResult).toBe(true);
        });
    });
    ...
    describe('validateInput() Method Test Suite', () => {
        ...
        it('should return true if the validateRequired method and validateNumber return true', () => {
            validateRequiredMock.mockReturnValue(true);
    ...
    describe('validateFormField() Method Test Suite', () => {
        ...
        it('should call the validateSelect() method awith the right parameters if the input is a select element', () => {
        ...
        it('should call the validateInput() with the right parameters if the input is an input element', () => {

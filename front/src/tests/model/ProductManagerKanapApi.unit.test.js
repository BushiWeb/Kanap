...
describe('ProductManagerKanapApi Unit Test Suite', () => {
    ...
    describe('getAllProducts() Method Test Suite', () => {
        ...
        it('should return all the products if not all the products are in the manager and the DAO returns all the products', async () => {
            ...
            productManager.products = [];
            apiDaoGetAllProductsMock.mockResolvedValueOnce(MOCKED_API_DATA);
            saveProductsMock.mockImplementationOnce(() => {
                productManager.products = MOCKED_PRODUCT_ENTITY_DATA;
            });
    ...
    describe('getProductsList() Method Test Suite', () => {
        ...
        beforeEach(() => {
            ...
            productsReturned = [MOCKED_PRODUCT_ENTITY_DATA[0], MOCKED_PRODUCT_ENTITY_DATA[1]];
        });
        ...
        it('should return an array of products entities and error messages', async () => {
            ...
            mockGetProduct
                .mockResolvedValueOnce(productsReturned[0])
                .mockResolvedValueOnce(productsReturned[1])
